  ...
  return (
    <div className="max-w-4xl">
      ...
      <p className="text-2xl text-slate-400">
        I'm {age} years old and currently working at <span className="text-white">SAP</span> as a full-time <span className="text-white">Android Developer</span>.
      ...
      <p className="text-2xl text-slate-400 pt-8">
        As a Community Lead, I'm responsible for <span className="text-white">organizing & managing</span> meetings where engineers from differet mobile teams at SAP come together to discuss the latest trends in Mobile & Android development.{" "}
      </p>
      <p className="text-2xl text-slate-400 pt-8">
        I'm currently on track to finish my Computer Science <span className="text-white">Masters</span> degree at the end of 2024 at the <span className="text-white">University of Applied Sciences Brandenburg</span>.
      </p>
    </div>
  );
}
