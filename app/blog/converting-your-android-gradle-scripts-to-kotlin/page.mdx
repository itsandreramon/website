...
Edit: You can also check out this converter: [https://github.com/bernaferrari/GradleKotlinConverter](https://github.com/bernaferrari/GradleKotlinConverter)
...
- [Using Gradle - Kotlin Programming Language](https://kotlinlang.org/docs/reference/using-gradle.html)
