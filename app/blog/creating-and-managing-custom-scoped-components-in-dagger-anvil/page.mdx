...
- Creating the custom user component
- Managing its lifecycle
- Wrapping everything up
- Bonus: Adding a user coroutine scope
...
- [Dagger + Anvil: Learning to Love Dependency Injection on Android](https://medium.com/r?url=https%3A%2F%2Fgpeal.medium.com%2Fdagger-anvil-learning-to-love-dependency-injection-on-android-8fad3d5530c9)
- [Refactoring our Dependency Injection using Anvil](https://www.reddit.com/r/RedditEng/comments/10vla9g/refactoring_our_dependency_injection_using_anvil/)
- [Managing state beyond ViewModels and Hilt](https://www.droidcon.com/2023/10/06/managing-state-beyond-viewmodels-and-hilt-2/)
